...
public class Farming {
    public static final List<AutoPot> pots = List.of(
            ...
            new AutoPot(new Location(Architect.FARM,103,-40,35),new Location(Architect.FARM,103,-36,35),Material.PITCHER_PLANT),
            new AutoPot(new Location(Architect.FARM,104,-32,34),new Location(Architect.FARM,106,-29,36),Material.PITCHER_PLANT),
            new AutoPot(new Location(Architect.FARM,-51,-42,61),new Location(Architect.FARM,-49,-39,63),Material.PITCHER_PLANT),
            new AutoPot(new Location(Architect.FARM,108,-55,40),new Location(Architect.FARM,108,-50,40),Material.PITCHER_PLANT),
