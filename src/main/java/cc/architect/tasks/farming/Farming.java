...
public class Farming {
    public static final List<AutoPot> pots = List.of(
            ...
            new AutoPot(new Location(Architect.FARM,11,-42,-112),new Location(Architect.FARM,14,-39,109),Material.PITCHER_CROP),
            new AutoPot(new Location(Architect.FARM,-44,-39,66),new Location(Architect.FARM,-40,-36,70),Material.PITCHER_CROP),
    ...
    public static void breakBlockFarm(BlockBreakEvent e){
        ...
        if(b.getRelative(0,-1,0).getType().equals(Material.PITCHER_CROP)) {
