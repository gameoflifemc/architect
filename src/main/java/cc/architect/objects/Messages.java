...
public class Messages {
    ...
    public static final Component FARMING_HARVEST = Component.text("You now have your crops grown and you should harvest them. You can do that for the next 60 seconds").color(Colors.GREEN);
    public static final Component FARMING_END = Component.text("Harvesting is over. Go to the main lobby and sell your crops.").color(Colors.GREEN);
    public static final Component FARMING_TREASURE = Component.text("Your hoe got stuck under a bunch of emeralds.").color(Colors.GREEN);
    public static final Component FARMING_CANNOT_BONEMEAL = Component.text("You can't apply bone meal to that block").color(Colors.RED);
    public static final Component FARMING_CANNOT_HARVEST = Component.text("You can't harvest that block").color(Colors.RED);
    public static final Component FARMING_MUSHROOM_GUIDE = Component.text("You have to click then wait 3 seconds and then click again for successful harvest of mushrooms").color(Colors.RED);
