...
public class Meta {
    ...
    public static final String LOAN_RISKY_MAP = "loan_lich_map";
    public static final String LOAN_RISKY_COUNTER = "loan_lich_counter";
    public static final String LOAN_SAFE = "loan_spor";
    public static final String LOAN_SAFE_HADLOAN = "loan_spor_hadloan";
    // highest values
